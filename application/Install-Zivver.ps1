$ApplicationName = "Zivver Office Plugin"
$Archive = "$($env:temp)\Zivver.OfficePlugin.Installer.msi"
$installDescription = "Installing the latest version of $($ApplicationName) $($Archive)"
$DownloadURL = "https://downloads.zivver.com/officeplugin/latest/Zivver.OfficePlugin.Installer.msi"
...
try {
  ...
  $arguments=@(
    ...
    Start-Process $Archive -ArgumentList $arguments -wait
