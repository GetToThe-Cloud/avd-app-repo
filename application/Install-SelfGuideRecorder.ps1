$ApplicationName = "SelfGuideRecorder"
$Archive = "$($env:temp)\SelfGuideRecorderSetup.exe"
$installDescription = "Installing the latest version of $($ApplicationName) $($Archive)"
$DownloadURL = "https://ppprodsa001.blob.core.windows.net/website/SelfGuideRecorderSetup.exe"
...
try {
  ...
  Start-Process -Wait -FilePath $Archive -ArgumentList '/S /ALLUSERS'
